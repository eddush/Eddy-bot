    ...
    if (interaction.isStringSelectMenu() && interaction.customId === 'ticket_main_select') {
      ...
      if (choice === 'apply_team') {
        ...
        const aboutInput = new TextInputBuilder()
          .setCustomId('about')
          .setLabel('# טופס קבלה להלפר בדיסקורד #
1 בן כמה אתה?
2 איך תרצה שניקרה לך?
3 איך אתה רוצה שהצוות יקרא לך אם תתקבל?
4 האם יש לך נסיון בשרתי דיסקורד אחרים בתור מוד,הלפר וכמה שחקנים יש בשרת?
5 אם שחקן יקלל בצ'אט או בוויס איך תטפל בו? וכמה אזהרות תתן לו?
6  אם שחקן יעשה ספאם בצ'אט איך תטפל בו? וכמה אזהרות תתן לו?
7 למה אתה חושב שדווקא לך מתאים להיות צוות בשרת הדיסקורד שלנו?
8 כמה זמן ביום אתה חושב שתוכל להיות פעיל?


נא לענות ברצינות שתסיים נבדוק אותך ותקבל תשובה')
